...
Musicly is a desktop music player created with Visual Studio 2019, C# and [NAudio](https://github.com/naudio/NAudio).
I developed Musicly as a way for myself to enjoy music while studying, coding, etc 😊.
...
<b>The app has NO setup, so this is a Visual Studio project you're gonna run here.</b>  
